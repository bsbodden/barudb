...
mod tests {
    ...
    fn test_empty_filter() {
        let bloom = DynamicBloom::new(100, 2);
    ...
    fn test_different_sizes() {
        for bits in [64, 128, 256, 512, 1024] {
            let bloom = DynamicBloom::new(bits, 6);
    ...
    fn test_hash_distribution() {
        let bloom = DynamicBloom::new(1024, 6);
    ...
    fn test_false_positive_rate() {
        ...
        let bloom = DynamicBloom::new(2048, 6); // ~20 bits per key
    ...
    fn test_different_bit_ratios() {
        for &bits_per_key in &[4, 8, 12, 16] {
            ...
            let bloom = DynamicBloom::new(total_bits, num_probes);
    ...
    fn test_varying_lengths() {
        for length in 1..=25 {
            let bits = length * 10;
            let bloom = DynamicBloom::new(bits as u32, 6);
    ...
    fn test_concurrent_throughput() {
        ...
        let bloom = Arc::new(DynamicBloom::new(total_bits, 6));
        let mut threads = vec![];
    ...
    fn test_performance() {
        ...
        for m in 1..=8 {
            ...
            let bloom = DynamicBloom::new((num_keys * 10) as u32, 6);
    ...
    fn test_memory_efficiency() {
        for bits_per_key in [10, 20, 40] {
            ...
            let bloom = DynamicBloom::new(total_bits as u32, 6);
